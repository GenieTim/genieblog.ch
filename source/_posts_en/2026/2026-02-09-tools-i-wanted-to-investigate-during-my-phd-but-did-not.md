...
- Besides Ginkgo, there are many other linear algebra libraries, such as [Armadillo](http://arma.sourceforge.net/), [Eigen](https://eigen.tuxfamily.org/), [Kokkos](https://kokkos.org/about/overview/), or a project from [Trilinos](https://trilinos.github.io/index.html). Eigen is what I used for [pylimer-tools](https://github.com/GenieTim/pylimer-tools/). I have not explored the others in depth, but they could also be worth investigating for potential performance improvements in my codes.
