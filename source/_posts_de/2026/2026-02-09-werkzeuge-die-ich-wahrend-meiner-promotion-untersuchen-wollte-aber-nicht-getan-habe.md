...
- Neben Ginkgo gibt es viele weitere Bibliotheken für lineare Algebra, wie zum Beispiel [Armadillo](http://arma.sourceforge.net/), [Eigen](https://eigen.tuxfamily.org/), [Kokkos](https://kokkos.org/about/overview/), oder ein Projekt aus [Trilinos](https://trilinos.github.io/index.html). Eigen habe ich für [pylimer-tools](https://github.com/GenieTim/pylimer-tools/) genutzt. Die anderen habe ich noch nicht ausführlich untersucht, aber sie könnten sich auch lohnen, wenn es um mögliche Leistungsverbesserungen in meinen Codes geht.
