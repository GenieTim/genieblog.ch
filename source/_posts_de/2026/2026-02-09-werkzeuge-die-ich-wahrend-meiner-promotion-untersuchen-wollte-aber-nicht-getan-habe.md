...
Ich habe kürzlich meine Promotion im Fachbereich Materialwissenschaften an der ETH Zürich abgeschlossen.
...
- und die Entwicklung neuer Methoden zur Vorhersage makroskopischer Eigenschaften, darunter [Normalmodusanalyse](https://doi.org/10.1021/acs.macromol.4c01429) für Viskoelastizität und das [MEHP-Kraftausgleichsverfahren](https://doi.org/10.1021/acspolymersau.5c00036) für den Gleichgewichtsschermodul,
...
Software, die ich nie untersucht habe, die mich aber interessiert hat
...
- [`treedifferencing`](https://github.com/FAU-Inf2/treedifferencing): Für Arbeiten, die ich selbst geschrieben habe, habe ich LaTeX verwendet. Während der Überarbeitungen musste ich manuell angeben, ob eine Änderung eine Löschung, eine Ergänzung oder eine Modifikation war, was zeitaufwendig und fehleranfällig war. Ich habe versucht, `latexdiff` zu erweitern, dann ein neues Tool mit Vibe-Coding gebaut, aber beide hatten Einschränkungen. Später fand ich `treedifferencing`, was ein entscheidendes Puzzlestück hätte sein können, und ich wünschte, ich hätte es früher entdeckt.
...
- [Ginkgo](https://github.com/ginkgo-project/ginkgo): Sowohl die Normalmodusanalyse als auch das MEHP-Kraftausgleichverfahren verwenden dünnbesetzte Matrizen, um Polymernetzwerke darzustellen. Obwohl ich dort bereits Sparse-Solver anwende, habe ich Ginkgo, eine Hochleistungsbibliothek für dünnbesetzte lineare Algebra, noch nicht erkundet. Es könnte die Leistung großer Systeme verbessern.
- Neben Ginkgo gibt es viele weitere Bibliotheken für lineare Algebra, wie zum Beispiel [Armadillo](http://arma.sourceforge.net/), [ViennaCL](https://viennacl.sourceforge.net/doc/index.html), [Kokkos](https://kokkos.org/about/overview/), [MAGMA](https://icl.utk.edu/magma/), oder ein Projekt aus [Trilinos](https://trilinos.github.io/index.html). Eigen habe ich für [pylimer-tools](https://github.com/GenieTim/pylimer-tools/) genutzt. Die anderen habe ich noch nicht ausführlich untersucht, aber sie könnten sich auch lohnen, wenn es um mögliche Leistungsverbesserungen in meinen Codes geht.
