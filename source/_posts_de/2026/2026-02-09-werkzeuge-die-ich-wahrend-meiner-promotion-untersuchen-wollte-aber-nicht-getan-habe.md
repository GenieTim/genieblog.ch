...
*   Neben Ginkgo gibt es viele weitere spärliche Bibliotheken für lineare Algebra, wie zum Beispiel [Armadillo](http://arma.sourceforge.net/), [Eigen](https://eigen.tuxfamily.org/), oder ein Projekt aus [Trilinos](https://trilinos.github.io/index.html). Eigen, das habe ich für genutzt [Pylimerwerkzeuge](https://github.com/GenieTim/pylimer-tools/). Die anderen habe ich noch nicht ausführlich untersucht, aber sie könnten sich auch lohnen, sie für mögliche Leistungsverbesserungen in meinen Codes zu untersuchen.
