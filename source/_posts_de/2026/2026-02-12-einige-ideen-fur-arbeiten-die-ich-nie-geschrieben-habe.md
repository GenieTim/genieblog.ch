...
6.  **Korrelieren von Eigenwerten mit topologischen Eigenschaften**: In der Normalmodusanalyse erhält man ein Spektrum von Eigenwerten, die mit den viskoelastischen Eigenschaften des Polymernetzwerks zusammenhängen. Es wäre interessant zu untersuchen, wie diese Eigenwerte mit den topologischen Eigenschaften des Netzwerks korrelieren, wie etwa dem Schleifenanteil, den hängenden und freien Fraktionen, der Stränglängenverteilung und anderen topologischen Eigenschaften. Dies könnte Einblicke darüber geben, wie die Netzwerkstruktur seine viskoelastischen Eigenschaften beeinflusst.
